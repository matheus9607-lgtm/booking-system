...
async function saveRoom(event) {
    ...
    // Handle file upload if selected (only if file input exists)
    if (fileInput && fileInput.files.length > 0) {
        ...
        try {
            ...
            imageUrl = `${backendOrigin}${uploadResult.url}`;
    ...
    const roomData = {
        ...
        image: imageUrl || 'https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=2069&auto=format&fit=crop'
    };
